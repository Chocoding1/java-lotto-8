...
public class ErrorMessage {
    ...
    public static final String DUPLICATE_NUMBER_IN_LOTTO = "[ERROR] 당첨 번호와 중복된 번호가 존재합니다.";
    public static final String LOTTO_CONTAINS_DUPLICATE_NUMBERS = "[ERROR] 로또는 중복된 숫자를 포함하지 않아야 합니다.";
